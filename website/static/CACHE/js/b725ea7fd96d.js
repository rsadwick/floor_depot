...
{e.stopPropagation();$this.removeClass('open');document.removeEventListener('touchstart',closeDropdown);});}}},false);});}});$(function(){$('.mezzanine-form :input:visible:enabled:first').focus();});