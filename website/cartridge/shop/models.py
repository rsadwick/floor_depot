...
class Order(SiteRelated):
    ...
    billing_detail_city = CharField(_("City"), max_length=100)
    billing_detail_state = CharField(_("State"), max_length=100)
    billing_detail_postcode = CharField(_("Zipcode"), max_length=10)
    ...
    shipping_detail_city = CharField(_("City"), max_length=100)
    shipping_detail_state = CharField(_("State"), max_length=100)
    shipping_detail_postcode = CharField(_("Zipcode"), max_length=10)
